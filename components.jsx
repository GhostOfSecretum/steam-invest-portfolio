...
const I18N = {
  en: {
    ...
    sections: {
      ...
      news: 'CS2 News Radar',
      newsSub: 'Posts from a Telegram channel, aggregated on the backend and refreshed automatically.',
      armory: 'Armory Pass Payback',
      armorySub: 'Rank Armory rewards by star ROI using live Steam prices. Compare no-risk grinds vs pass-efficient ★/hr, with optional Steam fee haircut.',
      stats: 'The numbers',
    ...
    news: {
      ...
      empty: 'No posts loaded yet. Check Telegram settings on the backend or press Refresh.',
      telegram: 'Telegram',
    ...
    dash: {
      ...
      leadersHint: 'held items · real price history',
      leadersEmpty: 'History providers rate-limited — try Sync later',
      trendsMore: 'More',
      trendsLess: 'Less',
  ...
  ru: {
    ...
    sections: {
      ...
      news: 'CS2 · новости',
      newsSub: 'Посты из Telegram-канала, собранные на сервере и обновляемые автоматически.',
      armory: 'Окупаемость Armory Pass',
      armorySub: 'Рейтинг наград Armory по ROI звёзд на live-ценах Steam. Сравни безрисковый гринд и эффективный ★/час пасса, с учётом комиссии Steam.',
      stats: 'Цифры',
      faq: 'Частые вопросы',
    },
    news: {
      ...
      empty: 'Посты пока не загрузились. Проверьте настройки Telegram на бэкенде или нажмите «Обновить».',
      telegram: 'Telegram',
    ...
    dash: {
      ...
      bestLeaders: 'Лучшие',
      worstLeaders: 'Худшие',
      leadersHint: 'позиции портфеля · реальная история цен',
      leadersEmpty: 'Источники истории временно ограничены — нажми Sync позже',
      trendsMore: 'Ещё',
      trendsLess: 'Свернуть',
